...
const FoodsIndex = () => {
    ...
    return (
        <div className="container-fluid">
            ...
            <Link to="/foods/create" className="btn btn-primary mb-2">Create</Link>
                            ...
                            <tbody>
                                {foods.map((foodss, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{foodss.ingredients}</td>
                                        <td>{foodss.category}</td>
                                        <td>{foodss.image_url}</td>
                                        <td>
                                            <Link to={`/foods/update/${foodss.id}`} className="btn btn-sm btn-info">Edit</Link>
                                            <button 
