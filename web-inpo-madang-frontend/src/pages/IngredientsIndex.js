...
const IngredientsIndex = () => {
    ...
    return (
        <div className="container-fluid">
            ...
            <Link to="/ingredients/create" className="btn btn-primary mb-2">Create</Link>
                            ...
                            <tbody>
                                {ingredients.map((ingredientss, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Link to={`/ingredients/update/${ingredientss.id}`} className="btn btn-sm btn-info">Edit</Link>
                                            <button 
