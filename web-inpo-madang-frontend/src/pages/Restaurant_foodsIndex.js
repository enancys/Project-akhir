...
const Restaurant_foodsIndex = () => {
    ...
    return (
        <div className="container-fluid">
            ...
            <Link to="/restaurant_foods/create" className="btn btn-primary mb-2">Create</Link>
                        ...
                        <table className="table table-bordered" width="100%" cellSpacing="0">
                            ...
                            <tbody>
                                {restaurant_foods.map((restaurant_foodss, index) => (
                                    <tr key={index}>
                                        <td>{restaurant_foodss.restaurant_id}</td>
                                        <td>{restaurant_foodss.food_id}</td>
                                        <td>
                                            <Link to={`/restaurant_foods/update/${restaurant_foodss.restaurant_id}`} className="btn btn-sm btn-info">Edit</Link>
                                            <button 
